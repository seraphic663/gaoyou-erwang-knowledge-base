    ...
    \begin{columns}[T]
        ...
        \begin{block}{研究对象明确}
            \begin{itemize}
                ...
                \item 可结构化：材料核对、证据组织和判断步骤，可转为可保存、可检索、可循证的结构。
            \end{itemize}
        \end{block}
        \column{0.48\textwidth}
        \begin{block}{切入点独特}
...
\begin{frame}{两条数据库搭建路线}
    ...
    \vspace{0.25cm}
    \begin{center}
        \key{成熟成果与研究工作稿分离；人工标注—AI草案—人工循证—规则迭代形成闭环}
    \end{center}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{exampleblock}{迁移方向}
            \begin{itemize}
                ...
                \item 目标：让同类问题可比较、可循证
            \end{itemize}
        \end{exampleblock}
    \end{columns}
    \vspace{0.25cm}
    \begin{center}
        \pill{文本结构化} \quad \pill{过程可循证} \quad \pill{场景可迁移}
    \end{center}
\end{frame}
