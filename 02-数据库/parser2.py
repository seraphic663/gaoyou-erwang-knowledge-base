"""
parser2.py — 《广雅疏证》source.txt 清洗拆分脚本
...
用法：
  python parser2.py                 # 输出到控制台
  python parser2.py --output parsed_data.py   # 输出到文件
  python parser2.py --verbose       # 显示详细处理过程
  python parser2.py --limit 5      # 仅处理前 N 条（测试用）
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "\n用法示例：\n"
            "  python parser2.py                     # 打印全部\n"
            "  python parser2.py -v                   # 详细输出\n"
            "  python parser2.py -n 5                # 仅前 5 条（测试）\n"
            "  python parser2.py -o parsed_data.py   # 输出到文件\n"
        ),
    )
